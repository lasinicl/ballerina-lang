...
public class BLangOrderByClause extends BLangNode implements OrderByClauseNode {
    public List<BLangOrderKeyClause> orderByKeyList = new ArrayList<>();
    ...
    public void addOrderKey(OrderKeyNode orderKeyNode) {
        orderByKeyList.add((BLangOrderKeyClause) orderKeyNode);
    }

    @Override
    public List<BLangOrderKeyClause> getOrderKeyList() {
    ...
    public String toString() {
        ...
        for (BLangOrderKeyClause orderKeyList : orderByKeyList) {
