...
type Participant object {
    ...
    isolated function prepare(string protocol) returns [(PrepareResult|error)?, Participant];

    isolated function notify(string action, string? protocolName) returns (NotifyResult|error)?;
};
...
class LocalParticipant {
    ...
    isolated function init(string participantId, TwoPhaseCommitTransaction participatedTxn, LocalProtocol[]
